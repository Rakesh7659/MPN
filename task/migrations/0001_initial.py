...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'task_taskcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'task', ['TaskCategory'])

        # Adding model 'Task'
        db.create_table(u'task_task', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['task.TaskCategory'])),
            ...
            ('assigned_to_ymht', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ymht.YMHT'], null=True, blank=True)),
            ('assigned_to_coordinator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ymht.Coordinator'], null=True, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'task_taskcategory')
    ...
    models = {
        ...
        u'task.task': {
            ...
            'assigned_to_coordinator': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ymht.Coordinator']", 'null': 'True', 'blank': 'True'}),
            'assigned_to_ymht': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ymht.YMHT']", 'null': 'True', 'blank': 'True'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['task.TaskCategory']"}),
